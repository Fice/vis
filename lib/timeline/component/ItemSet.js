...
ItemSet.prototype._onDragStartAddItem = function (event) {
  ...
  alert('itemset')
  var start = snap ? snap(time, scale, step, null) : start;
  var end = start;
      ...
      if (updateTimeAllowed) {
        if (props.dragLeft) {
          ...
          if (itemData.start != undefined) {
            ...
            itemData.start = snap ? snap(start, scale, step, null) : start;
          }
        }
          ...
          if (itemData.end != undefined) {
            ...
            itemData.end = snap ? snap(end, scale, step, null) : end;
          }
        }
        else {
          ...
          if (itemData.start != undefined) {
            ...
            if (itemData.end != undefined) {
              ...
              itemData.start = snap ? snap(start, scale, step, new Date(start.valueOf() + duration)) : start;
...
ItemSet.prototype._onAddItem = function (event) {
  ...
  if (item) {
    ...
    var newItem = {
      start: snap ? snap(start, scale, step, null) : start,
      content: 'new item'
    };
    ...
    if (this.options.type === 'range') {
      ...
      newItem.end = snap ? snap(end, scale, step, null) : end;
    }
